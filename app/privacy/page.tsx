  ...
  return (
    <LegalPage title="Privacy Policy">
      ...
      <ul>
        ...
        <li>
          <strong>Workout history, food log and calorie settings.</strong> Your finished sets (exercise, reps, form
          results, estimated calories, date), the foods you log, the body weight and daily calorie goal you enter, and
          whether you muted the voice coach are saved in your browser&apos;s local storage (
          <code>formai:history</code>, <code>formai:food</code>, <code>formai:profile</code>,{" "}
          <code>formai:muted</code>). They power the Progress page, <strong>never leave
