      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 md:flex-row md:items-start md:justify-between">
        <div className="max-w-sm">
          ...
          <p className="mt-3 text-sm text-muted-dark">
            Your AI form coach and calorie tracker. Pose tracking runs on your device. No video is recorded or uploaded.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-8 text-sm sm:grid-cols-3">
          <nav aria-label="Product" className="flex flex-col gap-2">
            ...
            <Link href="/food" className="text-muted-dark hover:text-cream">Food log</Link>
